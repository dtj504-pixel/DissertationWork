...
We are sampling eight points per round to reduce computation time [@HumanOutOfTheLoopBayesian],[@Originalpaper]. Now, we will look at the mathematics behind the methods above and also at the acquisition functions of Expected Improvement, Augmented Expected Improvement and Knowledge Gradient which I added to the original code.
...
hihglight how stock s in different regiions and toy mdoel so doesn't really amtch rael data. also ices doesn't use mixme.

# Conclusion and Further areas for Development

We have created a framework that ... - FILL IN BEFORE DRAFT SUBMISSION
