...
The convergence tests I ran after augmenting the original method in @Originalpaper with different acquisition functions confirmed that my method still led to convergence to the correct point identified in the paper for every acquisition function. This can be found in @sec-Appendix.
