...
Sustainable fisheries management requires a delicate balance of maximising long-term catch whilst keeping the risk of stock depletion below precautionary thresholds [@ICES2021precautionary]. Traditionally, Management Strategy Evaluation (MSE) grid searches are used to find optimal HCRs [@Harvest_Control_Rules],[@ICES2019WKGMSE2]. However, simulating these complex, interconnected dynamics is computationally expensive and time-consuming, particularly as management shifts from single-stock assessments to more realistic, multispecies mixed fisheries [@Originalpaper],[@MixedFisheriesStatusandManagement2023]. Finding ways to improve current MSE grid searches in single stock and mixed fisheries contexts, such as those presented in this paper, could be beneficial for the fishing industry [@Originalpaper],[@MixME],[@ParallelandOtherSimulationsInRMadeEasy].

PREVIOSU WORK DONE HERE
