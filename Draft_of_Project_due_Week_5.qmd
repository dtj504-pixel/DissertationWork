...
![Figure 8: case_study8.R with the mean of the GP set to zero in all rounds at the seventh round](case_study8_mean_zero_all_rounds_draft_report.png)

![Figure 9: case_study8.R augmented with the KG acquisition function with the mean of the GP set to zero in the first round only, at the seventh round](case_study8_KG_mean_zero_first_round_only_draft_report.png)

![Figure 10: case_study8.R augmented with the KG acquisition function with the mean of the GP set to zero in all rounds at the seventh round](case_study8_KG_mean_zero_all_rounds_draft_report.png)
