...
This can be done using @eq-posteriordistributiongivensamples. A diagram is provided below to improve visualisation:

![](images/Calculating risk demonstration.png)
