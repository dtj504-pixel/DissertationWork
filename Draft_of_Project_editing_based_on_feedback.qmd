...
The logs for my runs of the shortcut model and the model based on the fixed fishing mortality example can be found as FILLL IN FOLDER NAMES in the repository.