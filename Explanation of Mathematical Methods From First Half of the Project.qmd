...
The risk GP models $ln(risk)$ and the catch GP models $ln(catch)$ . To maintain the notation from the Spence 2025 paper, we use $m_1$ for the mean function of the log(catch) GP and $m_2$ for the mean function of the risk GP [@Originalpaper]:
...
In the code, we predict the $ln(catch)$ and $ln(risk)$ at every point in the design space using the code below:
