...
Now, we repeat the process described above until there are no points with a positive KG. Then, the optimal point is the $x^*$ has the highest catch out of the precautionary points.
