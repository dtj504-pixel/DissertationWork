...
We then use this in the `makeMixME` function to make the MixME model, which can then be run to create our projections into the future.

We have five arguments here. Two of these are where we input our Operating Model and our Observation Error model.
