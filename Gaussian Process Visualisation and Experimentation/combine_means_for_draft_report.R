# case_study8 mean zero first round only
...
# 7 Rounds and 54 evaluations now to converge
...
possible_case_study_mean_zero_first_round <- possible7
pcat_case_study_mean_zero_first_round <- pcat7



### case study mean zero all rounds
...
possible_case_study_mean_zero <- possible7
pcat_case_study_mean_zero <- pcat7
...
possible_case_study_KG_mean_zero_first_round <- possible
pcat_case_study_KG_mean_zero_first_round <- pcat


## case study with kg mean zero all roudns
...
possible_case_study_KG_mean_zero <- possible
pcat_case_study_KG_mean_zero <- pcat
...
image2D(matrix(possible_case_study_KG_mean_zero_first_round * (1-pcat_case_study_KG_mean_zero),nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftarget",breaks=c(-1e-12,0.0001,0.05,0.5,0.9,1))
image2D(matrix(possible_case_study_KG_mean_zero * (1-pcat_case_study_KG_mean_zero),nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftarget",breaks=c(-1e-12,0.0001,0.05,0.5,0.9,1))
