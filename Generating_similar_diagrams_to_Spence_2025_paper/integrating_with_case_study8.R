...
setEPS()
cairo_ps("case_study8_round_1_GP.eps", width = 10, height = 10)
...
# Add 99.9% line
lines(x_vals_F_orig, qs_cat_F[, "upper_999"], lwd = 2, lty = 3)

# Add horizontal line at best safe catch
abline(h = best_catch_so_far, col = "black", lty = 2, lwd = 2)
...
lines(x_vals_B_orig, qs_cat_B[, "upper_999"], lwd = 2, lty = 3)
...
lines(x_vals_F_orig, qs_risk_F[, "upper_999"], lwd = 2, lty = 3)
...
lines(x_vals_B_orig, qs_risk_B[, "upper_999"], lwd = 2, lty = 3)
