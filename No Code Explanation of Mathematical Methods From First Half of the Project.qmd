...
HIGHLIGHT THAT COMBINING THIS WITH AN ACQUISITION FUCNTION WAS AN IDEA I HAD BEFORE READING ANY LITERATURE ON IT ( AS I THINK THERE IS SOME).
...
To do this, Spence uses two GPs where the risk GP models $ln(risk)$ and the catch GP models $ln(catch)$ [@Originalpaper]. Maintaining the notation from the Spence 2025 paper, we use $m_1$ for the mean function of the catch GP and $m_2$ for the mean function of the risk GP [@Originalpaper]:
