...
MAYBE NOT ENOUGH INFO ON THESE TWO BELOW TO INCLUDE THEM?
...
We set up the forecast arguments in a similar way to before, but make sure to set them separately for each stock.
